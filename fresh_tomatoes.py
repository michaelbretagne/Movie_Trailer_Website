      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="https://www.udacity.com/">Movie Trailers</a>
          </div>
        </div>
      </div>
    </div>
...
def create_movie_tiles_content(videos):
    ...
    content = ''
    for video in videos:
        choice = video.__class__.__name__
        if choice == "Movie":   # if you choose to watch the movies trailers
            ...
            content += movie_tile_content.format(
                ...
                year_release=video.year_release,
                runing_time=video.runing_time,
                rating=video.movie_rating,
        ...
        # if you choose to watch the tv shows trailers
            ...
            content += tvshow_tile_content.format(
                tvshow_title=video.title,
                year_release=video.year_release,
                runing_time=video.runing_time,
                rating=video.movie_rating,
                poster_image_url=video.poster_image_url,
                trailer_youtube_id=trailer_youtube_id,
                number_of_seasons=video.number_of_seasons
            )
